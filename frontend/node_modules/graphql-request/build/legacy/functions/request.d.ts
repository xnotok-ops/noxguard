...
import type { RequestDocument, RequestOptions, TypedDocumentString, Variables, VariablesAndRequestHeadersArgs } from '../helpers/types.js';
/**
...
export declare function request<T = any, V extends Variables = Variables>(url: string, document: RequestDocument | TypedDocumentNode<T, V> | TypedDocumentString<T, V>, ...variablesAndRequestHeaders: VariablesAndRequestHeadersArgs<V>): Promise<T>;
