...
import type { RawRequestOptions, RequestDocument, RequestOptions, TypedDocumentString, Variables } from '../legacy/helpers/types.js';
...
export { BatchRequestDocument, BatchRequestsExtendedOptions, BatchRequestsOptions, ClientError, GraphQLResponse, type RawRequestOptions, request, type RequestDocument, type RequestExtendedOptions, RequestMiddleware, type RequestOptions, ResponseMiddleware, type TypedDocumentString, type Variables, };
